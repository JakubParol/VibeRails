...
| Document | Purpose |
|---|---|
| `../README.md` | Project overview, setup, structure, and quality gate. |
| `../AGENTS.md` | AI agent rules and required reading for this project. |
...
- Repository index: `<relative-path-to-repo>/docs/INDEX.md`
