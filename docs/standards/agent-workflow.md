...
| Design/change rendered web UI | [Web UI/UX](web-ui.md) and its visual acceptance, plus [frontend](frontend.md) for Next.js/React implementation. Read conditional data/AI sections only when applicable; reuse the target design direction. |
