...
```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action ListActive -Project <project> -Repository <repository>
```

Read PR details:

```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Show -PrId <pr-id> -Project <project> -Repository <repository>
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action WorkItems -PrId <pr-id> -Project <project> -Repository <repository>
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Reviewers -PrId <pr-id> -Project <project> -Repository <repository>
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Policies -PrId <pr-id> -Project <project> -Repository <repository>
```

Read PR commits and threads:

```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Commits -PrId <pr-id> -Project <project> -Repository <repository>
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Threads -PrId <pr-id> -Project <project> -Repository <repository>
```

Create a draft PR only after branch, commit, push, and approval:

```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action CreateDraft -SourceBranch <branch> -TargetBranch main -Title "<title>" -DescriptionPath <markdown-file> -Project <project> -Repository <repository> -AllowRepoMutation
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action UpdateDescription -PrId <pr-id> -DescriptionPath <markdown-file> -Project <project> -Repository <repository> -AllowRepoMutation
```
...
```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action SelfReviewStatus -PrId <pr-id> -Project <project> -Repository <repository>
```
...
```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 `
...
```powershell
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Approve -PrId <pr-id> -Project <project> -Repository <repository> -AllowRepoMutation
.\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action SetReviewerVote -PrId <pr-id> -Vote reset -Project <project> -Repository <repository> -AllowRepoMutation
```
