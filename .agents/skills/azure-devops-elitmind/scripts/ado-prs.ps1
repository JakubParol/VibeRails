...
switch ($Action) {
    "Context" {
        [ordered]@{
            ...
            source = "Parameters, ELITMIND_ADO_* environment variables, or current git remote"
    ...
    "Doctor" {
        ...
        } -NextStep "Pass -Org/-Project/-Repository or set ELITMIND_ADO_* environment variables."
