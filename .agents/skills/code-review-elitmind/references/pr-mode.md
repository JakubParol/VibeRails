...
2. Load
   [`../../azure-devops-elitmind/SKILL.md`](../../azure-devops-elitmind/SKILL.md)
...
4. Read PR metadata:
   ...
   ```powershell
   .\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Show -PrId <id> -Project <project> -Repository <repository>
   ```
...
5. Record repository ID/name, source branch, target branch, latest source commit, target commit,
   ...
   ```powershell
   .\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action SelfReviewStatus -PrId <id> -Project <project> -Repository <repository>
   ```
...
8. Read PR iterations and latest iteration changes before publishing inline comments:
   ...
   ```powershell
   .\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action Iterations -PrId <id> -Project <project> -Repository <repository>
   .\.agents\skills\azure-devops-elitmind\scripts\ado-prs.ps1 -Action IterationChanges -PrId <id> -Project <project> -Repository <repository>
   ```
...
11. If direct Azure DevOps REST is unreliable, keep using the `azure-devops-elitmind` wrapper
...
[`azure-devops-elitmind`](../../azure-devops-elitmind/references/prs.md#reliable-pr-commands).
