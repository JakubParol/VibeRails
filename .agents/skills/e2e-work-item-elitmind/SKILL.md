...
[`azure-devops-elitmind`](../azure-devops-elitmind/SKILL.md). Use its wrappers for work item
writes and comments.

Use `code-review-elitmind` only when the user explicitly asks for a review pass or the current
...
- [../azure-devops-elitmind/SKILL.md](../azure-devops-elitmind/SKILL.md) - Azure Boards and
  Azure Repos wrappers and safety rules.
- [../code-review-elitmind/SKILL.md](../code-review-elitmind/SKILL.md) - review workflow when
